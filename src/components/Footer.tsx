        ...
        <Container>
          <div className="pt-16 pb-10">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-x-12 gap-y-3 text-sm">
              ...
              <Link href="https://github.com/mikey242/">
                <span aria-label="Iseard Media on GitHub">
                  <svg
          ...
          <div className="flex flex-col items-center justify-center border-t border-slate-400/20 py-10 text-sm text-slate-500">
